...
///       The override variable is OFLM_PLATFORM, with the pre-rename
///       FLM_PLATFORM honoured as a fallback through utils::getenv_oflm.
...
/// \brief whether a column count belongs to a generation OFLM knows about
/// \param columns the column count reported by the NPU
...
/// \note Never throws. OFLM_PLATFORM ("aie2p"/"aie4") overrides detection and is
