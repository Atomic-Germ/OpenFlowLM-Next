...
REM ships with this repo. Override with env vars:
...
REM The defaults below are the phlegm checkout's copies (deps/XRT headers and
REM the import lib its m0/build_m0.cmd generates from C:\Windows\System32\xrt_coreutil.dll).
setlocal
cd /d "%~dp0"
